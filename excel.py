...
FIELDS = [
    {"key": "Ad Soyad", "label": "Ad Soyad", "type": "entry", "hint": "Örn: Ahmet Yılmaz"},
    {"key": "Başvurduğu Pozisyon", "label": "Başvurduğu Pozisyon", "type": "entry", "hint": "Örn: Elektrik Elektronik"},
    {"key": "Üniversite", "label": "Üniversite", "type": "entry", "hint": "Örn: İstanbul Üniversitesi"},
    {"key": "Okuduğu Bölüm", "label": "Okuduğu Bölüm", "type": "entry", "hint": "Örn: Elektrik Elektronik Mühendisliği"},
    {
        "key": "Eğitim Düzeyi",
        "label": "Eğitim Düzeyi",
        "type": "combo",
    ...
    {"key": "Mezuniyet Tarihi", "label": "Mezuniyet Tarihi", "type": "entry", "hint": "Örn: 06.2024 veya 2024-06 (boş bırakılabilir)"},
    {"key": "Not Ortalaması", "label": "Not Ortalaması", "type": "entry", "hint": "Örn: 3.12/4.00 veya 78/100 (boş bırakılabilir)"},
    {"key": "Doğum Yılı", "label": "Doğum Yılı", "type": "entry", "hint": "Sadece yıl: 1990 (boş bırakılabilir)"},
    {"key": "İş Deneyimi Var mı?", "label": "İş Deneyimi Var mı?", "type": "radio", "values": ["Evet", "Hayır"], "hint": ""},
    {"key": "Şu an Çalışıyor mu?", "label": "Şu an Çalışıyor mu?", "type": "radio", "values": ["Evet", "Hayır"], "hint": ""},
    {"key": "Mevcut Firma", "label": "Mevcut Firma", "type": "entry", "hint": "Şu an çalışıyorsa yaz (boş bırakılabilir)"},
]
...
class App(ttk.Frame):
    ...
    def _build_ui(self):
        ...
        header.pack(fill="x")
        ttk.Label(header, text="Aday Bilgisi Girişi", style="Header.TLabel").pack(anchor="w")
    ...
    def _collect_current(self):
        ...
        TEXT_KEYS = {"Ad Soyad", "Başvurduğu Pozisyon", "Üniversite", "Okuduğu Bölüm", "Mevcut Firma"}
    ...
    def _save_candidate_and_reset(self):
        ...
        messagebox.showinfo("Kaydedildi", f"Aday kaydedildi ✅ (Satır: {self.current_row})\nYeni adaya geçiliyor.")
        self.current_row += 1
        self.answers = {}
        self._show_field(0)
